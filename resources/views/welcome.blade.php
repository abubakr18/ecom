...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text">
            ...
            <p>تمنياتي لكم بزيارة طيبة،هنا ستجد كل شيء بإذن الله</p>
...
<div class="container">
    <div class="content-head">
        <h2 style="text-align:center; font-weight: bold">حي الجامعة</h2>
        <p style="text-align: center">متجر متكامل تجد كل مستلزمات : مواد غذائية، أحذية وملبوسات، أجهزة إلكترونية وأشياء عديدة </p>
    </div>
    <h2 class="header text-center">منتجاتنا</h2>
    <!-- start products row -->
    <div class="row">
    ...
    <div class="show-more">
        <a href="{{ route('shop.index') }}">
            <button class="btn custom-border-n">عرض المزيد</button>
        </a>
    </div>
    <hr>
    <h2 class="header text-center">منتجات حصرية</h2>
    <!-- start products row -->
    <div class="row">
